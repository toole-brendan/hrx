...
import { Button } from "@/components/ui/button"; // Props interface for the component
...
const MaintenanceListHeader = ({ sortConfig, onSort }: { 
  sortConfig: { field: keyof MaintenanceItem | 'none'; order: 'asc' | 'desc' }; 
  onSort: (field: keyof MaintenanceItem | 'none') => void;
}) => { 
  return ( 
        ...
        <div className="py-4 px-0 flex flex-col md:flex-row gap-3"> 
          <div className="relative flex-grow"> 
            <Input 
              ...
              className="pl-10 h-9 rounded-none" 
            /> 
