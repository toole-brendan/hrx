...
const RecentActivity: React.FC = () => {
  ...
  return (
    <Card className="overflow-hidden border-gray-200 shadow-none bg-white">
      <div className="p-4 flex justify-between items-baseline bg-gray-900">
        <div>
          <div className="uppercase text-xs tracking-wider font-medium text-gray-400 mb-1">
            ACTIVITY LOG
          </div>
        ...
        <Button
          variant="ghost"
          className="text-xs uppercase tracking-wider text-gray-400 hover:bg-transparent hover:text-white"
      ...
      <CardContent className="p-0 bg-white">
        {recentActivities.length === 0 ? (
          ...
          <div className="divide-y divide-gray-200 px-4 pb-2">
