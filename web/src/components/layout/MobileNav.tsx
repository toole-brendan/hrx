...
const MobileNav: React.FC<MobileNavProps> = () => {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 flex justify-around p-3 z-10">
      <Link href="/">
        <div className={`flex flex-col items-center justify-center ${isActive('/') ? 'text-purple-600' : 'text-gray-500'}`}>
      ...
      <Link href="/transfers">
        <div className={`flex flex-col items-center justify-center ${isActive('/transfers') ? 'text-purple-600' : 'text-gray-500'}`}>
