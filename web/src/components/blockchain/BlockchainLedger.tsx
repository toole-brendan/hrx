...
import { 
  Lock, ShieldCheck, ArrowRightLeft, AlertTriangle, RefreshCw, 
  Link as ChainLink, CheckCircle
} from 'lucide-react';
      ...
      {loading ? (
        ...
        <ul className="space-y-3 text-sm">
          {records.map((record, index) => (
            <li key={index} className="flex items-start space-x-3 border-b border-gray-100 pb-3 last:border-0">
